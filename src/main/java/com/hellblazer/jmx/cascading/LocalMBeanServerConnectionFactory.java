 ...
 * <tt>MBeanServerConnection</tt>, e.g, an <tt>MBeanServer</tt>. The default
 * implementation of this class is to always return the
 * <tt>MBeanServerConnection</tt> passed to its constructor. The add/remove
 * connection listener methods are not implemented - they simply do nothing,
 * because the underlying <tt>MBeanServerConnection</tt> is expected to be a
 * local <tt>MBeanServer</tt>, or an object that wraps a local
 * <tt>MBeanServer</tt>.
 * 
 * @since Java DMK 5.1
 **/
public class LocalMBeanServerConnectionFactory implements
     ...
     * {@link LocalMBeanServerConnectionFactory#LocalMBeanServerConnectionFactory(MBeanServerConnection,String)
     * new LocalMBeanServerConnectionFactory(s,cid)}.
     * 
     * @param s
     *            A local <tt>MBeanServer</tt> for which to obtain a
    ...
    public static MBeanServerConnectionFactory newInstance(MBeanServer s) {
        ...
        try {
            mbsid = (String) s.getAttribute(CascadingAgent.MBSDelegateObjectName,
                                            "MBeanServerId");
        } catch (Exception x) {
     ...
     * 
     * @param local
     *            A local <tt>MBeanServerConnection</tt>. This
     ...
     *            <code>MBeanServerConnectionFactory</code> for a remote agent,
     *            use the {@link BasicMBeanServerConnectionFactory} instead.
     * @param localID
     *            An ID identifying this local connection. This is the string
     *            that will be returned by {link #getConnectionId()}.
     **/
    ...
    /**
     * <p>
     * This implementation does nothing. Since local connections never change,
     * they never emit notifications.
     * </p>
     * 
     */
    ...
    /**
     * <p>
     * Returns the connection ID identifying this local connection, as passed to
    ...
    /**
     * Return the local <code>MBeanServerConnection</code> as passed to the
     * constructor of this object. Usually this
