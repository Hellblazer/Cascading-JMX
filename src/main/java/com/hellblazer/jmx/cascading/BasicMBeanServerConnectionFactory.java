...
public class BasicMBeanServerConnectionFactory implements
    ...
    /**
     * Creates a new instance of the <tt>BasicMBeanServerConnectionFactory</tt>.
     * This is equivalent to
     * {@link #BasicMBeanServerConnectionFactory(JMXConnector,Subject) new
     * BasicMBeanServerConnectionFactory(c,null)}.
     * 
     * @param c
     *            A <tt>JMXConnector</tt>. The connector must be connected
     ...
     * This is equivalent to
     * {@link #BasicMBeanServerConnectionFactory(JMXConnector,Subject) new
     * BasicMBeanServerConnectionFactory(c,subject)}.
     * 
     * @param c
     *            A <tt>JMXConnector</tt>. The connector must be connected
     *            before the returned factory can be used.
     * @param subject
     *            A subject for the underlying <tt>MBeanServerConnection</tt>.
     ...
     * 
     * @param url
     *            A JMX Service URL from which to create a <tt>JMXConnector</tt>
     *            .
     * @throws IOException
     *             if a connected connector cannot be obtained from the
     ...
     *            .
     * @param map
     *            An attributes map passed to the
     ...
     * {@link JMXConnector connector} with the given {@link Subject
     * delegationSubject}. The given connector must be connected before the
     * factory can be used.
     * 
     * @param connector
     *            A <tt>JMConnector</tt> from which to obtain the
     *            <tt>MBeanServerConnection</tt>.
     * @param delegationSubject
     *            A delegation subject used to obtain the underlying
     ...
     * <tt>MBeanServerConnection</tt>. This is the {@link Subject} that was
    ...
    /**
     * Returns the underlying <code>JMXConnector</code> used by this object.
     * This is the connector that was passed to this object's constructor.
     * 
     ...
     * </p>
     * <p>
     * This implementation always return the same <tt>MBeanServerConnection</tt>
     * object. The first time <code>getMBeanServerConnection()</code> is called,
     * this method will obtain a new <code>MBeanServerConnection</code> by
     * calling <code>
